...
module.exports = {
  ...
  run: async (client, message, args) => {
        ...
        if(!message.member.hasPermission("MANAGE_ROLES")) return message.channel.send(':x: You do not have permission.')
        ...
        message.channel.send(`:white_check_mark: ${target.user.username} roles has been removed`) //this is optional and editable
    }
}
