    ...
    if(!message.member.hasPermission("MANAGE_SERVER"))
{
 ...
 checkc.setRateLimitPerUser(vc1, `Responsible - ${message.member}`);
     ...
     message.reply(":white_check_mark: Done i have deleted the channel of chatbot from my database");
     return;
  }
  else {
    return message.reply(":x: You dont have a channel Please add it first");
  }
  }
}
